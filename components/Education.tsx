...
const education = [
  ...
  {
    degree: 'Producción multimedia y Desarrollo',
    ...
    color: '#ffd700',
    icon: '🏆',
    description: 'Tecnólogo en producción multimedia y desarrollo con enfasis en desarrollo de soluciones multimedia y desarrollo de software web con PHP y JS',
  },
  {
    degree: 'Tecnología en Automatización y Robotica Industrial',
    ...
    color: '#ff00aa',
    icon: '📱',
    description: 'Estudios tecnológicos en Automatizacion industrial, robotica y desarrollo de software especializado en ambientes de industria autonoma',
  },
  {
    degree: 'Bachillerato',
